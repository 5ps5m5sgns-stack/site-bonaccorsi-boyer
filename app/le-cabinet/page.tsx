            ...
            {values.map((v, i) => (
              <StaggerItem key={v.title}>
                <div className="bg-parchment p-10 h-full">
                  ...
                  <p className="font-jost text-lg text-stone font-light leading-relaxed">{v.desc}</p>
                </div>
              </StaggerItem>
            ))}
          </AnimatedStagger>
            ...
            {memberships.map((m) => (
              <StaggerItem key={m.abbr}>
                <div className="border border-stone/15 p-8 h-full">
                  ...
                  <p className="font-jost text-base text-stone font-medium tracking-wide mb-4">{m.full}</p>
                  <p className="font-jost text-lg text-stone/70 font-light leading-relaxed">{m.desc}</p>
                </div>
              </StaggerItem>
            ))}
          </AnimatedStagger>
      ...
      <section className="bg-burgundy py-20 lg:py-24">
        <div className="max-w-screen-xl mx-auto px-6 lg:px-10 text-center">
          <AnimatedSection>
            ...
            <p className="font-jost text-lg text-cream/70 font-light max-w-md mx-auto mb-10 leading-relaxed">

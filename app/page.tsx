      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-charcoal">
        ...
        <div className="relative z-10 max-w-screen-xl mx-auto px-6 lg:px-10 w-full pt-32 pb-24">
          ...
          <div className="animate-fade-in-up" style={{ animationDelay: '0.9s' }}>
            ...
            <p className="font-jost text-sm font-light text-stone max-w-lg leading-relaxed">
          ...
          <AnimatedSection>
            <div className="flex items-start gap-6 max-w-3xl mx-auto">
              ...
              <div>
                ...
                <p className="font-jost text-sm text-stone font-light leading-relaxed">
            ...
            {services.map((s) => (
              <StaggerItem key={s.num}>
                ...
                >
                  ...
                  <p className="font-jost text-xs text-stone font-light leading-relaxed mb-8">{s.desc}</p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-start">
            ...
            <div>
              <AnimatedSection>
                ...
                <p className="font-jost text-sm text-stone font-light leading-relaxed mb-10 max-w-sm">
                ...
                {divorceSteps.map((step, i) => (
                  ...
                  >
                    ...
                    <div>
                      ...
                      <p className="font-jost text-xs text-stone font-light leading-relaxed">{step.desc}</p>
                    </div>
                  </div>
                ))}
              </div>
        ...
        <div className="max-w-screen-xl mx-auto px-6 lg:px-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <AnimatedSection direction="right" delay={0.15}>
              ...
              <p className="font-jost text-sm text-stone font-light leading-relaxed mb-6">
